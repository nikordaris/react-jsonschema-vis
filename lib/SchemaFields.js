...
function _compare() {
  ...
  return function (a, b) {
    ...
    var vA = (0, _selectors.getLabel)(obj[a], a);
    var vB = (0, _selectors.getLabel)(obj[b], b);
  ...
  _createClass(SchemaForm, [{
    ...
    value: function isSchemaEmpty(schema) {
      ...
      return (0, _lodash.has)(schema, 'properties') && (0, _lodash.isEmpty)((0, _lodash.map)(schema.properties).filter(function (prop) {
        return (0, _selectors.getEditable)(prop, prefix, false);
      }));
    }
  }, {
    key: 'renderFields',
    value: function renderFields(schema, id, parentName) {
      ...
      return _react2.default.createElement(
        ...
        Object.keys(properties).filter(function (prop) {
          return (0, _selectors.getEditable)(properties[prop], prefix, false);
    ...
    value: function renderField(fieldSchema, idx, name, required, namespace) {
      ...
      var label = (0, _selectors.getLabel)(fieldSchema, prefix, name);
